...
namespace FolderDiffIL4DotNet.Tests.Services
{
    ...
    public sealed partial class HtmlReportGenerateServiceTests
    {
        ...
        public void GenerateDiffReportHtml_WhenReportPathIsInvalid_LogsWarningAndDoesNotThrow()
        {
            ...
            Assert.Contains("HtmlPathIsPathRooted=", warning.Message, StringComparison.Ordinal);
            Assert.Contains("HtmlPathLooksPathLike=", warning.Message, StringComparison.Ordinal);
