...
namespace FolderDiffIL4DotNet.Tests.Services
{
    ...
    public sealed class FolderDiffReportE2ETests : IDisposable
    {
        ...
        public async Task FullPipeline_DiffThenGenerateAllReports_ProducesCorrectOutputs()
        {
            ...
            var mdService = new ReportGenerateService(_resultLists, _logger, ReportGenerateService.CreateBuiltInSectionWriters());
        ...
        public async Task FullPipeline_ParallelMode_ProducesSameClassificationAsSequential()
        {
            ...
            new ReportGenerateService(_resultLists, _logger, ReportGenerateService.CreateBuiltInSectionWriters()).GenerateDiffReport(reportContext);
