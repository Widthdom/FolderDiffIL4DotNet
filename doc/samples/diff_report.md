...
| Property | Value |
|----------|-------|
| App Version | nildiff 1.0.0.0+98587820469656dc0794524de1e1bf03ae3f2b8a |
...
| `[ * ]` | util/Legacy.dll | 2026-03-15 08:50:00 → 2026-03-15 09:01:00 | `ILMismatch` `Low` | `Inline` | `dotnet-ildasm (version: 0.12.2)` | `.NET 6.0` → `.NET 8.0` |
