namespace FolderDiffIL4DotNet.Models
{
    ...
    /// <param name="ReferencingAssemblies">Assemblies that depend on this package (from .deps.json targets section). / このパッケージに依存するアセンブリ一覧（.deps.json の targets セクションから取得）。</param>
    public sealed record DependencyChangeEntry(
        ...
        System.Collections.Generic.IReadOnlyList<string>? ReferencingAssemblies = null);
}
