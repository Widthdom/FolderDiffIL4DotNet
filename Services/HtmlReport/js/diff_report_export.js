  ...
  async function downloadReviewed() {
    ...
    var colVarNames = ['--col-reason-w','--col-notes-w','--col-path-w','--col-ts-w','--col-diff-w','--col-tag-w','--col-disasm-w','--col-sdk-w','--col-checklist-item-w','--col-checklist-notes-w','--sc-class-w','--sc-basetype-w','--sc-type-w','--sc-name-w','--sc-rettype-w','--sc-params-w','--sc-body-w','--dc-refs-w'];
  ...
  function clearAll() {
    ...
    var root = document.documentElement;
    ['--col-reason-w','--col-notes-w','--col-path-w','--col-ts-w','--col-diff-w','--col-tag-w','--col-disasm-w','--col-sdk-w','--col-checklist-item-w','--col-checklist-notes-w','--sc-class-w','--sc-basetype-w','--sc-type-w','--sc-name-w','--sc-rettype-w','--sc-params-w','--sc-body-w','--dc-refs-w'].forEach(function(v){ root.style.removeProperty(v); });
    syncTableWidths();
