...
- [README](README.md#readme-en-doc-map): product overview and quick start
- [User Guide](USER_GUIDE.md#readme-en-doc-map): setup, usage, and configuration reference
...
- [README](README.md#readme-ja-doc-map): 製品概要とクイックスタート
- [ユーザーガイド](USER_GUIDE.md#readme-ja-doc-map): 導入、使い方、設定リファレンス
